            ...
            >
                {provided => (
                        ...
                        >
                    {
                        ...
                        <Button style={{visibility: editing? "visible":"hidden"}} shape="circle" size="small" type="danger" className="add-to-trip-button" onClick={this.handleDelete}><FontAwesomeIcon icon={faMinus} /></Button>
                        <Button style={{visibility: editing? "visible":"hidden"}} shape="circle" size="small" type="primary" className="add-to-trip-button" onClick={this.handleDuplicate}><FontAwesomeIcon icon={faPlus} /></Button>
                        </div>
                    </div>} 
                    </Container>
                )}
